...
export function EmailField() {
  ...
  return (
    <div className="flex flex-col justify-center items-center relative w-full sm:text-[15px]">
      <div
        className={`${
          isFinished ? "w-[47px] opacity-0 blur-[8px] scale-0" : "w-[270px]"
        } 
      ...
      >
        <div
         ...
         ${isFinished ? "bg-white" : "bg-black"}
          ${state === "EMAIL" && "w-[270px] border-zinc-400"}
          ${
            state === "NOTIFY" &&
            "hover:bg-white w-[135px] sm:w-[130px] hover:text-black text-zinc-200 hover:border-white border-zinc-600 hover:border-white"
          }
